...
import { FloorSectionGrid, StatusLegend, Filters, computeAvailableFloors, computeAvailableRoomsCounts, computeAvailableSections } from './FloorSectionGrid'
import type { FilterOptions } from './FloorSectionGrid'
